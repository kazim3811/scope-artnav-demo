      ...
      <header className="bg-white border-b border-gray-200">
        <div className="flex items-center justify-between px-6 py-3">
          <div className="flex items-center space-x-3">
            ...
            <span className="text-[#8E9196] text-sm">Gallery Forms</span>
          </div>
        </div>
      </header>

      <div className="p-6 max-w-3xl">
        <h1 className="text-2xl font-bold mb-4 text-[#1A1F2C]">Welcome to Gallery Forms</h1>
        
        <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-100 space-y-4">
          <section>
            <h2 className="text-base font-semibold mb-2 text-[#1A1F2C]">Complete Your Gallery Information</h2>
            <p className="text-[#8E9196] text-sm">Welcome to the gallery forms section. Please provide your gallery information below.</p>
          </section>

          <section>
            <h2 className="text-base font-semibold mb-2 text-[#1A1F2C]">What to Expect</h2>
            <p className="text-[#8E9196] text-sm">
              The process is simple and straightforward. You'll need to:
            </p>
